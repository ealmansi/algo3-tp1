Lo que hallamos (y demostraremos posteriormente en este informe) es que el orden óptimo es de menor a mayor según el coeficiente $\frac{Tiempo_i}{Perdida_i}$. Dicho orden es el siguiente:
